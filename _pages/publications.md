...
**Ferreira, A.** (2025). A Warning Label on the Use of AI Safety Evaluations [Working Paper]. Centre for International Governance Innovation Digital Policy Hub. [Access](https://www.cigionline.org/publications/a-warning-label-on-the-use-of-ai-safety-evaluations/).
...
**Ferreira, A.**, Mahip, S., Capra, A., Carli, I., Duque Quiceno, D., Fedorko, W. T., Fujiwara, M., Li, M., Martin, L., Saito, Y., Smith, G., Xu, A. (2024). ALPHA-g Preprocessed Simulation Dataset for Machine Learning [Dataset]. Zenodo. [Access](https://zenodo.org/records/13963779).
...
\\(^2\\) Looking back, I see many huge ways to criticize this paper... 